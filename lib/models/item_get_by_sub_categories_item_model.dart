...
// class ItemGetBySubCategoryIdModel {
//   int? status;
//   String? message;
//   List<ProductModel>? data;
//
//   ItemGetBySubCategoryIdModel({this.status, this.message, this.data});
//
//   ItemGetBySubCategoryIdModel.fromJson(Map<String, dynamic> json) {
//     status = json['status'];
